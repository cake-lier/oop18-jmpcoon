...
public interface ModifiablePhysicalWorld {
     ...
     * {@link it.unibo.jmpcoon.model.entities.Entity} which contains the passed {@link PhysicalBody} is also registered for future cross-checks.
     ...
     * {@link it.unibo.jmpcoon.model.entities.Player}'s {@link SerializableBody}. This method is needed for the same reasons as the previous ones,
     * but exclusively for the {@link it.unibo.jmpcoon.model.entities.Player} because it possesses a different {@link PhysicalBody} with
     ...
     * {@link it.unibo.jmpcoon.model.entities.Entity}. Because the physics of a {@link it.unibo.jmpcoon.model.entities.PowerUp} needs to know to which
     ...
     * @param powerUpType the {@link PowerUpType} of the {@link it.unibo.jmpcoon.model.entities.PowerUp} which {@link SerializableBody} is
     * the one passed
     */
