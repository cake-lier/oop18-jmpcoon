...
public interface ModifiablePhysicalWorld {
     ...
     * should be able to see it is a {@link ModifiablePhysicalWorld}. The {@link EntityType} of the {@link Entity} which
     * contains the passed {@link PhysicalBody} is also registered for future cross-checks.
     ...
     * @param type The {@link EntityType} of the {@link Entity} containing the {@link PhysicalBody}.
     */
