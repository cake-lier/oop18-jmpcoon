...
public interface PhysicalWorld {
    ...
    /**
     * Gets all bodies currently colliding with this {@link PhysicalBody} associated with
     * the points in world coordinates in which they are colliding with this body.
     * @param body The {@link PhysicalBody} from which to get all {@link PhysicalBody}s
     * colliding with it.
     * @return A {@link Set} made with {@link Pair}s of a colliding
     * {@link PhysicalBody} and the point in which is colliding with the passed
     * {@link PhysicalBody}.
     */
