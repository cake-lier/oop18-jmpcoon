...
public class PlayerView extends DynamicDrawableEntity {
     ...
     * @param player The {@link UnmodifiableEntity}.
     ...
     */
    public PlayerView(final Map<EntityState, Pair<Image, Integer>> spritesheets, final UnmodifiableEntity player,
            final Pair<Double, Double> worldDimensions, final Pair<Double, Double> sceneDimensions) {
        super(spritesheets.get(EntityState.IDLE).getLeft(), player, worldDimensions, sceneDimensions);
